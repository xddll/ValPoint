...
const prereqItems = [
  {
    image: {
      light: new URL('../public/aliyun_dark.png', import.meta.url).href,
      dark: new URL('../public/aliyun.png', import.meta.url).href,
    },
    name: '阿里云',
  ...
  {
    image: {
      light: new URL('../public/supabase_dark.png', import.meta.url).href,
      dark: new URL('../public/supabase.png', import.meta.url).href,
    },
    name: 'Supabase',
  ...
  {
    image: {
      light: new URL('../public/piclist_dark.png', import.meta.url).href,
      dark: new URL('../public/piclist.png', import.meta.url).href,
    },
    name: 'Piclist',
  ...
  {
    image: {
      light: new URL('../public/nodejs_dark.png', import.meta.url).href,
      dark: new URL('../public/nodejs.png', import.meta.url).href,
      crop: true,
    },
    name: 'NodeJS',
    desc: '版本 >= 18',
  ...
  {
    image: {
      light: new URL('../public/npm_dark.png', import.meta.url).href,
      dark: new URL('../public/npm.png', import.meta.url).href,
    },
    name: 'npm',
    desc: '无版本要求',
    link: 'https://piclist.cn/',
