...
请参考 `docs/prompt.md` 中的开发规则：

1. **禁止向 App.tsx 写入业务代码**
2. **新功能必须模块化拆分**
3. **强制 TypeScript 类型安全**
4. **UI 与逻辑分离**
5. **Supabase 使用规范**
...
```bash
# 功能开发
git commit -m "feat: 添加作者信息自动获取功能"

# Bug 修复
git commit -m "fix: 修复图片防盗链问题"

# 文档更新
git commit -m "docs: 更新 WIKI 文档"

# 样式调整
git commit -m "style: 优化编辑器布局"
```
